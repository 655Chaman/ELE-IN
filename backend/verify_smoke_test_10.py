...
try:
    ...
    supabase.table("campaign_enrollments").insert({
        ...
        "workspace_id": ws_id,
        "campaign_version_id": test_version_id
    }).execute()
    ...
    res8 = supabase.rpc("release_lead_claim", {
        ...
        "p_next_status": "pending", "p_next_node": str(uuid.uuid4()), "p_next_run": None,
    ...
    supabase.table("campaign_versions").delete().eq("id", test_version_id).execute()
