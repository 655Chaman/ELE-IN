...
ALTER TABLE public.daily_workspace_stats ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW();
ALTER TABLE public.daily_campaign_stats ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW();
...
-- 3. Rewrite the Rollup RPC to use the modern campaign_execution_states schema and include hubspot_deal_won
