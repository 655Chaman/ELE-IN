...
export function SalesNavImport() {
  ...
  return (
    <div className="animate-in fade-in max-w-xl">
      ...
      <div className="mt-4 p-4 rounded-lg bg-primary/10 dark:bg-primary/20 border border-primary/20 text-warning dark:text-primary/80 text-sm flex gap-3 items-start">
