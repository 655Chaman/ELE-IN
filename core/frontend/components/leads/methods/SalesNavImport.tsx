...
export function SalesNavImport() {
  ...
  return (
    <div className="animate-in fade-in max-w-xl">
      ...
      <div className="mt-4 p-4 rounded-lg bg-amber-500/10 dark:bg-amber-500/20 border border-amber-500/20 text-amber-600 dark:text-amber-400 text-sm flex gap-3 items-start">
