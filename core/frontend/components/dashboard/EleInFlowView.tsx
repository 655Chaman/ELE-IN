                 ...
                 {stepData.id === 'campaigns' && (
                   <div className="w-full max-w-[260px] flex flex-col items-center">
                     <motion.div 
                       ...
                       className="p-3 rounded-2xl bg-background/80 border border-primary/30 flex items-center gap-3 shadow-lg w-full z-10"
                     >
                       <div className="p-2 bg-primary/20 rounded-lg"><Users size={16} className="text-primary"/></div>
                       <div className="h-2 w-20 bg-foreground/20 rounded-full"></div>
                     </motion.div>
                     ...
                     >
                       <div className="p-2 bg-primary/20 rounded-lg"><Send size={16} className="text-primary"/></div>
                     ...
                     >
                       <div className="p-2 bg-primary/20 rounded-lg"><Activity size={16} className="text-primary"/></div>
                       <div className="h-2 w-16 bg-foreground/20 rounded-full"></div>
                     </motion.div>
                   </div>
                 )}
